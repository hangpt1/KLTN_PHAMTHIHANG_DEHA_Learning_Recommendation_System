...
class StudentClusterer:
    ...
    def silhouette(self, students_df, activities_df, quizzes_df):
        """
        Compute silhouette score on scaled features for the fitted clustering model.
        Returns None when undefined (e.g., 1 cluster).
        """
